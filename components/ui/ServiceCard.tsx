  ...
  return (
    <div className={styles.serviceCard}>
      ...
      <div className={styles.cardContent}>
        ...
        {service.maturationTitle && service.maturationDescription && (
          <div className={styles.maturationPanel} aria-hidden="true">
            <p className={styles.maturationTitle}>{service.maturationTitle}</p>
            <p className={styles.maturationDescription}>{service.maturationDescription}</p>
          </div>
        )}
      </div>
    </div>
